...
Data set (only Japanese) used for evaluation examples are as follows:
...
- [Fleurs](https://huggingface.co/datasets/google/fleurs) (CC-BY)
   - read-speech
   - test set of ja-jp
   - different audio conditions (e.g. background noise)
...
- ESPnet models (character-based ASR) for streaming: trained in our [lab](https://github.com/ouktlab/espnet_asr_models).
   - ESPnet-st(Corpus10) (0.25 sec. segment in inference) with `disable_repetition_detection=True`
      - JSUT is semi-closed set for Corpus10 model (jvs corpus used for training)
   - ESPnet-stdr(Corpus10) (0.25 sec. segment in inference) with `disable_repetition_detection=False`
      - JSUT is semi-closed set for Corpus10 model (jvs corpus used for training)
...
| 02:ESPnet(CSJ full)         |     24.19 |      4.05 |     19.68 |     12.29 |     12.76 |     14.50 |     21.95 |     15.05 |      9.21 |     34.83 |
| 03:ESPnet(Corpus10)         |     18.54 |      3.76 |     10.14 |      6.78 |     10.07 |     10.56 |     17.01 |      5.24 |      5.63 |      7.17 |
| 04:SASR+SCT(Corpus10)       |     16.33 |      4.02 |      9.14 |      6.18 |      9.69 |     10.33 |     17.02 |      5.24 |      4.80 |      6.20 |
...
| 24:Reazon                   |     12.55 |     18.47 |      5.94 |      6.85 |     28.08 |     15.87 |     20.07 |      3.25 |      4.77 |      5.97 |
| 25:FunASR                   |     14.56 |     13.71 |      7.61 |      7.89 |      6.09 |     13.58 |     20.36 |      3.52 |      5.43 |      6.83 |
...
| ---                         | ---:      | ---:      | ---:      | ---:      | ---:      | ---:      | ---:      | ---:      | ---:      | ---:      |
| # of characters             |    139127 |    115744 |     32677 |    205375 |     56987 |     49406 |     23099 |      9747 |     26360 |    158160 |
...
| CER (%)                     |      cpjd |       csj |    fleurs |      jsut |      jvnv | spreds-d1 | spreds-d2 | spreds-p1 | spreds-u1 |spreds-u1-revbgn |
| ---                         | ---:      | ---:      | ---:      | ---:      | ---:      | ---:      | ---:      | ---:      | ---:      | ---:      |
| 01:ESPnet(CSJ core)         |     28.01 |      5.72 |     25.56 |     17.08 |     22.91 |     13.65 |     26.20 |     15.13 |     16.46 |     41.37 |
| 02:ESPnet(CSJ full)         |     18.67 |      3.57 |     15.54 |      7.91 |      9.24 |     10.98 |     18.82 |     12.03 |      6.01 |     32.32 |
| 03:ESPnet(Corpus10)         |     13.29 |      3.25 |      6.58 |      3.53 |      7.26 |      6.88 |     13.97 |      2.76 |      3.07 |      4.57 |
| 04:SASR+SCT(Corpus10)       |     11.25 |      3.44 |      5.29 |      2.24 |      6.37 |      7.08 |     14.12 |      2.48 |      1.69 |      3.21 |
...
| 24:Reazon                   |      7.98 |     14.21 |      4.51 |      3.09 |     10.06 |     13.99 |     17.38 |      1.30 |      1.52 |      2.72 |
| 25:FunASR                   |     11.16 |     10.95 |      6.61 |      5.07 |      4.97 |     11.93 |     18.65 |      2.20 |      2.86 |      4.37 |
...
|                             |      cpjd |       csj |    fleurs |      jsut |      jvnv | spreds-d1 | spreds-d2 | spreds-p1 | spreds-u1 |spreds-u1-revbgn |
| ---                         | ---:      | ---:      | ---:      | ---:      | ---:      | ---:      | ---:      | ---:      | ---:      | ---:      |
| # of characters             |    139137 |    115672 |     32686 |    205449 |     56987 |     49408 |     23103 |      9747 |     26382 |    158292 |
...
| CER (%)                     |      cpjd |       csj |    fleurs |      jsut |      jvnv | spreds-d1 | spreds-d2 | spreds-p1 | spreds-u1 |spreds-u1-revbgn |
| ---                         | ---:      | ---:      | ---:      | ---:      | ---:      | ---:      | ---:      | ---:      | ---:      | ---:      |
| 01:ESPnet(CSJ core)         |     28.01 |      5.64 |     25.25 |     17.04 |     22.91 |     12.16 |     26.03 |     15.16 |     16.22 |     41.23 |
| 02:ESPnet(CSJ full)         |     18.67 |      3.51 |     15.20 |      7.86 |      9.22 |      9.39 |     18.62 |     12.07 |      5.68 |     32.14 |
| 03:ESPnet(Corpus10)         |     13.29 |      3.20 |      6.24 |      3.47 |      7.25 |      5.31 |     13.75 |      2.70 |      2.63 |      4.22 |
| 04:SASR+SCT(Corpus10)       |     11.25 |      3.36 |      4.97 |      2.17 |      6.33 |      5.39 |     13.90 |      2.51 |      1.32 |      2.89 |
...
| 24:Reazon                   |      7.98 |     13.71 |      4.30 |      3.00 |     10.06 |     13.54 |     17.25 |      1.04 |      1.06 |      2.28 |
| 25:FunASR                   |     11.16 |     10.30 |      6.46 |      4.99 |      4.95 |     11.49 |     18.56 |      1.96 |      2.48 |      4.07 |
...
|                             |      cpjd |       csj |    fleurs |      jsut |      jvnv | spreds-d1 | spreds-d2 | spreds-p1 | spreds-u1 |spreds-u1-revbgn |
| ---                         | ---:      | ---:      | ---:      | ---:      | ---:      | ---:      | ---:      | ---:      | ---:      | ---:      |
| # of characters             |    139137 |    115676 |     32684 |    205483 |     56997 |     49377 |     23119 |      9747 |     26378 |    158268 |
