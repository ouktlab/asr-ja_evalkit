...
# 
if [ $# -le 10 ]; then
    resultpath=sasrct/${sasr_model}/nbeam-${sasr_nbeam}_ctcw-${ctcw}_lmw-${lmw}_penalty-${penalty}/${sct_model}/nbeam-${sct_nbeam}
    mkdir -p ${resultpath}
    ...
    for listname in ${@:11}; do        
        resultpath=sasrct/${sasr_model}/nbeam-${sasr_nbeam}_ctcw-${ctcw}_lmw-${lmw}_penalty-${penalty}/${sct_model}/nbeam-${sct_nbeam}/set-${listname}/
        mkdir -p ${resultpath}
